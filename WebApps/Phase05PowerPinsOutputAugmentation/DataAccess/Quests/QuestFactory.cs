using Phase05PowerPinsOutputAugmentation.RandomQuestGeneratorProcesses; //not common enough.

namespace Phase05PowerPinsOutputAugmentation.DataAccess.Quests;
